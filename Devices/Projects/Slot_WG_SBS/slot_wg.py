...
SOI = 300                   # SOI device layer thickness in nm 
...
create_ne_slot_waveguide_with_tapers(gaps[0], L, R, taper_start_width, taper_length, small_taper_length, layer_number, length).put(0,0)
...
#     # creating the slot
#     create_slot_waveguide_with_tapers(gaps[k], widths[2], taper_start_width, taper_length, small_taper_length, layer_number, length).put(0,(i+j+k+4)*space)
#     nd.strt(length=2*small_taper_length+2*taper_length+length,width=clad_width,layer=layer_clad).put()
#     f.text('Slot Gap = '+str(int(gaps[k]*1000))+' nm, width = '+str(int(widths[2]*1000)),layer=layer_number).put(100,50+(i+j+k+4)*space)
#     nd.strt(length=1000,width=100,layer=layer_clad).put(90,(i+j+k+4)*space + 80)
#     f.text(str(i+j+k+3),layer=layer_number).put(-250,(i+j+k+4)*space)         # numbering
#     f.text(str(i+j+k+3),layer=layer_number).put(2*small_taper_length+2*taper_length+length+220,(i+j+k+4)*space)         # numbering
#     if i+j+k+1 >= 10:
#         nd.strt(length=100,width=80,layer=layer_clad).put(-270,25+(i+j+k+4)*space)
#         nd.strt(length=100,width=80,layer=layer_clad).put(2*small_taper_length+2*taper_length+length+200,25+(i+j+k+4)*space)
#     else:
#         nd.strt(length=80,width=80,layer=layer_clad).put(-270,25+(i+j+k+4)*space)
#         nd.strt(length=80,width=80,layer=layer_clad).put(2*small_taper_length+2*taper_length+length+200,25+(i+j+k+4)*space)
        
        
# for m in range(len(gaps)):
#     # creating the slot
#     create_slot_waveguide_with_tapers(gaps[m], widths[3], taper_start_width, taper_length, small_taper_length, layer_number, length).put(0,(i+j+k+m+6)*space)
#     nd.strt(length=2*small_taper_length+2*taper_length+length,width=clad_width,layer=layer_clad).put()
#     f.text('Slot Gap = '+str(int(gaps[m]*1000))+' nm, width = '+str(int(widths[3]*1000)),layer=layer_number).put(100,50+(i+j+k+m+6)*space)
#     nd.strt(length=1000,width=100,layer=layer_clad).put(90,(i+j+k+m+6)*space + 80)
#     f.text(str(i+j+k+m+4),layer=layer_number).put(-250,(i+j+k+m+6)*space)         # numbering
#     f.text(str(i+j+k+m+4),layer=layer_number).put(2*small_taper_length+2*taper_length+length+220,(i+j+k+m+6)*space)         # numbering
#     if i+j+k+m+1 >= 10:
#         nd.strt(length=100,width=80,layer=layer_clad).put(-270,25+(i+j+k+m+6)*space)
#         nd.strt(length=100,width=80,layer=layer_clad).put(2*small_taper_length+2*taper_length+length+200,25+(i+j+k+m+6)*space)
#     else:
#         nd.strt(length=80,width=80,layer=layer_clad).put(-270,25+(i+j+k+m+6)*space)
#         nd.strt(length=80,width=80,layer=layer_clad).put(2*small_taper_length+2*taper_length+length+200,25+(i+j+k+m+6)*space)
