function[x,y,xsaw1,ysaw1,xsaw2,ysaw2,str]=RING_RACETRACK_cle2_N_taps_W3(Lc,d,R,x0,y0,Lt,ss)

%Global parameters
NTAPS=24;               %number of taps NTAPS>2
...
filt=3;                 %type of filter
loss_fix=1;             %losses cancelations
fig_flag=[1 1 1];       %figs flags
loss=13;                %dB/mm acoustic losses
%
